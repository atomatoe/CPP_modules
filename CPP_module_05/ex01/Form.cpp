...
/*   Updated: 2020/12/09 19:16:55 by atomatoe         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
    return ("Bureaucrat scores too high! No sign Form!");
}

const char* Form::GradeTooLowException::what() const throw()
{
    return ("Bureaucrat scores too low! No sign Form!");
}

const char* Form::Sign::what() const throw()
{
    return ("The form is already signed! Bureaucrat can't sign!");
}